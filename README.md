...
- [`Credit-card-fraud-detection.ipynb`](./Credit-card-fraud-detection.ipynb) — full code
- 📊 [View notebook with visualizations (nbviewer)](https://nbviewer.org/github/abrorxontoxirxonov-png/credit-card-fraud-detection/blob/main/Credit-card-fraud-detection.ipynb) — recommended, renders all charts
